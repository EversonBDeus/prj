    ...
    <b-form>
      <input id="article-id" type="hidden" v-model="article.id" />
          <b-form-group label="Nome: " label-for="article-name">
            ...
            :readonly="mode === 'remove' " required placeholder="Informe o Nome do Artigo..."></b-form-input>
          </b-form-group>
          ...
          <b-form-group label="Descriçao: " label-for="article-description">
            ...
            :readonly="mode === 'remove' " required placeholder="Informe o Nome a descricao..."></b-form-input>
          </b-form-group>
          ...
          <b-form-group  v-if="mode === 'save' "   label="Imagem (URL): " label-for="article-imageUrl">
            ...
            :readonly="mode === 'remove' " required placeholder="Informe a Image URL..."></b-form-input>
          </b-form-group>


          
          <b-form-group   v-if="mode === 'save' " label="Categoria : " label-for="article-articleId">
            <b-form-select id="article-articleId"
              :options="categories" v-model="article.articleId"></b-form-select>
...
export default {
  ...
  data() {
    return {
      ...
      fields: [
        ...
        { formatter: value => value ? 'Sim' : 'Não', label: 'Formato', sortable: true },
  ...
  methods:{
    ...
    loadCategories(){
      ...
      axios.get(url).then(res => {
        this.categorires = res.data.map(category =>{
